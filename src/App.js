...
class BooksApp extends Component {
  ...
  //get all the books from the API and added it to the state
  componentDidMount (){
  ...
  upDateBook = (book,shelf)=>{
    BooksAPI.update(book,shelf).then(res=>{
      //override the old shelf with the new one
      book.shelf=shelf;
      this.setState((currentState)=>({
        //filter the updated book and add it again to the array but UPDATED
    ...
    return (
      <div className="app">
        <Route exact path='/' render={()=>(
          <div>
             <AllBooks books={this.state.books} shelves={this.shelves} upDateBook={this.upDateBook} />
        ...
        <Route path='/search' render={()=>(
          <DoSearch books={this.state.books} upDateBook={this.upDateBook} />
